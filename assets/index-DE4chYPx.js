import { r as requireReact, g as getDefaultExportFromCjs, a as requireReactDom } from './vendor-CipSfvOw.js';
...
const container = "container__ueeVi";

const label = "label__1zifC";

const Field = ({ label: label$1, value, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: label, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: label$1 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        className: `${undefined} huy`,
        type: "text",
        value,
...
const Translate = ({ text }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: heading, children: translated !== "" ? translated : "Перевод" });
};

function App() {
  const [text, setText] = reactExports.useState("Реакция");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Введите русские слова", onChange: setText, value: text }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Translate, { text })
  ] });
}
